...
<title>Hibiscus Beach Resort and Spa in Mauritius, Indian Ocean, Pereybere - Spa</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../images/spa_ttl.png) bottom left no-repeat;">Spa</h1>
