...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(images/restaurantplage_ttl.png) bottom left no-repeat;">Restaurant Plage</h1>
            ...
            <div class="text">
            	...
            	<div class="ncontainr">
                                ...
                                <p>Information coming soon, as soon as the restaurant opens!</p>
