...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../images/mauritius_ttl.png) bottom left no-repeat;">Mauritius</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								<p style="padding-top:4px;"><img src="../images/google-map.png" width="18" height="18" style="padding-bottom:2px; vertical-align:middle; display:inline; margin-bottom:0px; margin-right:3px;"> <a title="Google Map" href="google-map.htm" style="margin-right:10px; color:#7f7f7f;">Google Map</a></p>
...
The local currency of Mauritius Island is the Mauritian Rupee: 1 euro + Rs 38,5.</p>

<p><strong>HOLIDAYING IN PEREYBERE</strong><br />
Situate in the North of Mauritius, Pereybere is undoubtedly  paradise on earth.. This small village bordering the sea has all the elements for a successful holiday. It has retained its cachet of intimacy and tranquillity  despite the effervescence of its neighbouring  sister Grand Baie, where shops, bars, restaurants and discos will animate both your days and nights. A stay at l’Hôtel Hibiscus Beach Resort, Spa and Dive Club de Péreybère, is to make the most of its serene and convivial ambiance whilst enjoying the delights of the North.</p>
