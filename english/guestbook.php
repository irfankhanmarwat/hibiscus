...
file_put_contents($xml_filename, stripslashes($result));
$data = json_decode(json_encode(simplexml_load_string(file_get_contents($xml_filename))), true);
...
<title>Hibiscus Beach Resort and Spa in Mauritius, Indian Ocean, Pereybere - Guestbook</title>
<meta name="description" content="Welcome to  Hibiscus Beach Resort and Spa on Mauritius island. Fill free to post your comment in our guestbook.">
...
#submit-form{width:60px; height:25px; margin-left:0px;}
.inputa{ width:180px;}
#reset-form{width:60px; height:25px;}
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../images/guestbook_ttl.png) bottom left no-repeat;">Info</h1>
            
            <div class="text">
                                                        <div id="buttonFormAdd">
    
                                            <img src="<?php echo $dot; ?>../images/expand.gif" border="0"  style="margin-right:5px; display:inline; cursor:pointer; padding-bottom: 2px; vertical-align: middle;" /><u>Write review</u>
    
                                            </div>
    
                                            <div id="buttonFormRem">
    
                                            <img src="<?php echo $dot; ?>../images/collapse.gif" border="0"  style="margin-right:5px; display:inline; cursor:pointer; padding-bottom: 2px; vertical-align: middle;" /><u>Close form</u>
            	...
            	<div class="ncontainr" style="height:156px;"> 
                    ...
                    <div style="margin-left:10px;" class="button2">
                                            ...
                                            <img src="<?php echo $dot; ?>../images/loading2.gif" border="0"  style="margin-right:3px;" />
                                        ...
                                        <div id="addForm">
                                            ...
                                            <td width="311" align="left"><input type="text" name="name" class="inputa" id="nameUser"></td>
                                            </tr>
                                            ...
                                            <td align="left"><input type="text" name="email" class="inputa" id="emailuser"><!--<span style="margin-left:3px;">Show email </span><input type="checkbox" name="email2" value="1">--></td>
                                            </tr>
    
                                            <tr> 
    
                                            <td><strong>Title of Post: </strong></td>
    
                                            <td align="left"><input type="text" name="title" class="inputa" id="postTitle"></td>
                                            </tr>
                                            ...
                                            <td align="left"><textarea name="post" id="postText" cols="20" style="width:300px; font-size:13px;" rows="4" wrap="VIRTUAL"></textarea></td>
                                            </tr>
                                            <tr>
                                              <td>
											...
											<td align="left">
                                              	<input name="submit" type="submit" id="submit-form" value="Submit" >
                                            	<input type="reset" name="Reset" id="reset-form" value="Reset">
                                            </td>
                                            </tr>
                                            </table>
