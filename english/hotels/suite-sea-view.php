...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/suite_ttl.png) bottom left no-repeat;">Suite Sea View</h1>
            ...
            <div class="text">
            	...
            	<div class="ncontainr">
                                ...
                                <h2 style="display:none;">Accommodation - Suite Sea View</h2>
