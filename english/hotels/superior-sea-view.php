...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/superiorseaview_ttl.png) bottom left no-repeat;">Superior Sea View</h1>
            ...
            <div class="text">
            	...
            	<div class="ncontainr">
                                ...
                                <h2 style="display:none;">Accommodation - Superior Sea View</h2>
