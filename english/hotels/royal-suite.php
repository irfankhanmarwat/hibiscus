...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/royalsuite_ttl.png) bottom left no-repeat;">Royal Suite</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Accommodation - Royal Suite</h2>
                                
                                <p>Enjoy your holidays in this 94 sq.m. amazing Royal Suite, the best accommodation for honeymooners and couples looking for romantic holidays! The Royal Suite offers a comfortable king size bed, spacious bathroom with Jacuzzi, private balcony with sitting area and sun bathing beds, gorgeous view and modern decoration with traditional wooden furniture. Feel the luxurious and warm atmosphere of Mauritius in this fabulous suite!</p>
