...
<title>Hibiscus Beach Resort and Spa in Mauritius, Indian Ocean, Pereybere - Senior Suite</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(images/suite_ttl.png) bottom left no-repeat;">Suite</h1>
            ...
            <div class="text">
            	...
            	<div class="scrollblock" id="scrollblock">  
                	...
                	<div id="scrollheight">
                                ...
                                <h2 style="display:none;">Accommodation - Suite</h2>
