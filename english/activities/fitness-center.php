...
<title>Hibiscus Beach Resort and Spa in Mauritius, Indian Ocean, Pereybere - Fitness Center</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/fitness-center_ttl.png) bottom left no-repeat;">Fitness Center</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Fitness Center</h2>
