...
$host = '185.140.47.172';
$user = 'sqlmaster';
$pass = '5nPASHQd2EEFPe7c';
$db   = 'greekao';

$greeka_connect = mysql_connect($host,$user,$pass);
...
$greeka = curl_init();
curl_setopt($greeka,CURLOPT_URL,"https://www.greeka.com/foreign_scripts/wp_sites_data.php?hotel_id=".$hotel_id."&language=".$lang."&ip=".$ip);
curl_setopt($greeka,CURLOPT_RETURNTRANSFER,true);
curl_setopt($greeka,CURLOPT_HEADER, false);
$results = json_decode(curl_exec($greeka));
curl_close($greeka);
...
foreach($results->countries as $result)
{
    ...
    {
        $country_drop_options .= 'selected="selected"';
	...
	<div id="wrapper" >
        ...
        <div class="show" ></div>
         ...
         <div id="content"  >
        	...
        	<h1 class="home_title" style="background:url(../images/contact_ttl.png) bottom left no-repeat;">Rates</h1>
