...
<title>Hibiscus Beach Resort und Spa in Mauritius, Indischer Ozean, Pereybere - Wasser- und sportliche Aktivitäten</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/watersport_ttl-ger.png) bottom left no-repeat;">Wasser- und sportliche Aktivitäten </h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Wasser- und sportliche Aktivitäten </h2>
                                
                                <p>In den Diensten, die das Hotel Hibiscus Beach Resort, Spa und Tauchclub anbietet, sind Schnorcheln um den Steg, Tretbootfahren, Kajakfahren enthalten.</p>
<p>Reservierungen für Katamaran-Kreuzfahrten, Fallschirmspringen, Meer-Wandern, Unterwasser-Safaris, Angeln, Wasserski, Tiefseetauchen, 'Bojen-Gleiten' und Schnorchel-Ausflüge können gegen Bezahlung getätigt werden.</p>
<p><strong>Entspannung und Sport</strong><br />
Sie können auch unsere Turnhalle benutzen oder eine Runde Palanquin oder Billard vor der Lagune genießen. Radfahren, Golf und Pferdereiten sind gegen Bezahlung verfügbar.</p>
<p><strong>Ausflüge</strong><br />
<p>Touren über die Insel Mauritius und Einkaufstouren können von unseren Rezeptionisten für Sie organisiert werden. </p>
