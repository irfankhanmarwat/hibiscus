...
<title>Hibiscus Beach Resort und Spa in Mauritius, Indischer Ozean, Pereybere - Fitnessstudio</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/fitness-center_ttl-ger.png) bottom left no-repeat;">Fitnessstudio</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Fitnessstudio</h2>
                                
                                <p>Genießen Sie zwischen 10.00 Uhr und 19.00 Uhr unseren Hammam, die Sauna, entspannende Massagen und Gesichts- und Körperbehandlungen in unserem Schönheits- und Gesundheitssalon.
</p>
