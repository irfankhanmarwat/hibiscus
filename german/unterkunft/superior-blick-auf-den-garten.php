...
<title>Hibiscus Beach Resort und Spa in Mauritius, Indischer Ozean, Pereybere - Superior Blick auf den Garten</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/superiorroom_ttl-ger.png) bottom left no-repeat;">Superior Blick auf den Garten</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Unterkunft - Superior Blick auf den Garten</h2>
