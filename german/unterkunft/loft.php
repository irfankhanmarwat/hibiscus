...
<title>Hibiscus Beach Resort und Spa in Mauritius, Indischer Ozean, Pereybere - Unterkunft - Loft</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/loft_ttl-ger.png) bottom left no-repeat;">Unterkunft</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Unterkunft - Loft</h2>
                                
                                <p>Bietet alles, was eine Senior-Suite bietet und einen eigenen Balkon.</p>
                                 
<div class="listing" style="margin:0px 0px 9px 35px; padding:-10px 0px 0px 0px;">
<ul style="padding:-10px 0px 0px 10px; margin:0px 0px 0px -10px;">
	<li>Größe - 52 m² mit Ausblick auf die Lagune.</li>
