...
<title>Hibiscus Beach Resort und Spa in Mauritius, Indischer Ozean, Pereybere - Superior-Zimmer</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/superiorroom_ttl-ger.png) bottom left no-repeat;">Superior-Zimmer</h1>
            
            <div class="text">
            
            	<div class="scroll-pane">
								
                                <h2 style="display:none;">Unterkunft - Superior-Zimmer </h2>
