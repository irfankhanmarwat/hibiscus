...
<title>Hibiscus Beach Resort und Spa in Mauritius, Indischer Ozean, Pereybere - Unterkunft</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/accom_ttl-ger.png) bottom left no-repeat;">Unterkunft</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Unterkunft</h2>

                                <p>Die geräumigen und attraktiv eingerichteten Zimmer des Hibiscus Beach Resort, Spa and Tauchclubs, bieten Ihnen eine Atmosphäre des Wohlbefindens und Komforts, die Sie während Ihres gesamten Aufenthalts im Hotel umgeben wird. Die Zimmer bieten Ihnen ohne Ausnahme Zugang zu einer Terrasse oder einem Balkon und Aussicht auf das Meer oder auf den Garten.</p>
<p>Die Zimmer haben ein Kingsize-Bett, eine Minibar, einen eigenen Safe, einen Fön, ein Telefon mit Direktwahl für Auslandsgespräche und kostenloses W-LAN. Satellitenfernsehen (Kino, Nachrichten, Musik und Kinder) ist ebenfalls in allen Zimmern vorhanden.</p>
<p>CD- und DVD-Player stehen in den Suiten zur Verfügung.</p>
<p>Die Badezimmer in den Superior-Zimmern sind geräumig und die Suiten haben einen Whirlpool.</p>
<p><strong>Die verfügbaren Zimmer sind</strong>:<br />
Superior-Zimmer: 47 m²<br />
Junior-Suite: 52 m²<br />
Senior-Suite: 60 m²<br />
Royal-Suite: 94 m²
