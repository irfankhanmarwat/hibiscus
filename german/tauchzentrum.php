...
<title>Hibiscus Beach Resort und Spa in Mauritius, Indischer Ozean, Pereybere - Tauchzentrum</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../images/divingcentre_ttl-ger.png) bottom left no-repeat;">Tauchzentrum</h1>
            ...
            <div class="text">
            	...
            	<div class="ncontainr">
                    ...
                    <h2 style="margin-top: 3px;"><p>ORCA Dive Club Mauritius</p></h2>
                               ...
                               <p>Seit dem Jahr 2007 bietet der ORCA Dive Club seinen Service auf Mauritius an. Das Hibiscus Boutique Hotel ist optimaler Ausgangspunkt für Tauchausflüge, viele Tauchspots sind in unmittelbarer Nähe, aber auch weitere Ausfahrten nach Coin de Mire, Sharks Pit und Trou aux Biches sind möglich. Das geräumige Tauchboot startet direkt vom hoteleigenen Steg, von der Tauchbasis bis zum Steg sind es nur ein paar Meter.</p>
                                <p>Die Tauchbasis verfügt über ausreichend Verleih Equipment, 10/12/15 Liter Stahlflaschen mit Luft oder Nitrox. </p>
                <p>Freies Schnuppertauchen im Hotelpool jederzeit möglich, Discover Scuba Dives in der Lagune oder an einem dafür geeigneten Tauchspot auch jederzeit möglich.</p>
               <p>Tauchkurse vom Beginner bis hin zum Divemaster nach den Standards von PADI und SSI.</p>
<p>Rama und sein Team freuen sich auf gemeinsame Tauchgänge mit euch.</p>
