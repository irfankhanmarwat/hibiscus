...
if ( isset($out['TotalRooms']) && $out['TotalRooms']>0 )
{
	...
	if ($show_terms!="") 
	{
		...
		<br>
		<br>
		<strong><u>Dauer und Bedingungen:</u></strong><br>
		'.$show_terms;
	}
	$priceList1 .= '</p>';
} 
...
if ( isset($out['TotalRooms']) && $out['TotalRooms']>0 )
{
	...
	{
		$priceList2 .= '
		<strong style="font-size:13px; margin-bottom:5px;">Notiz:</strong><br />
		'.$show_notes;
	}
	...
	if ($show_terms!="") 
	{
		$priceList2 .= '
		<br>
		<strong style="font-size:13px; padding-bottom:5px;">Dauer und Bedingungen:</strong><br />
		'.$show_terms;
	}
	$priceList2 .= '</p>';
} 
...
<title>Hibiscus Beach Resort und Spa in Mauritius, Indischer Ozean, Pereybere - TARIFS</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../images/rates_ttl-ger.png) bottom left no-repeat;">PREISE </h1>
