			...
			slides 					:  	[			// Slideshow Images
												...
												{image : '../images/juniorsuite/2.jpg'},
													{image : '../images/juniorsuite/3.jpg'},
														{image : '../images/juniorsuite/4.jpg'},
															{image : '../images/juniorsuite/5.jpg'},
												{image : '../images/juniorsuite/6.jpg'}
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(images/loftsuite_ttl-ger.png) bottom left no-repeat;">Loft Suite</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Hébergement - Loft Suite</h2>
