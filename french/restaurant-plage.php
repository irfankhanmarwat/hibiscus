...
<title>Hibiscus Beach Resort and Spa à l’île Maurice, Océan Indien, Pereybère - Restaurant Plage</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../images/restaurantplage_ttl-fr.png) bottom left no-repeat;">Restaurant Plage</h1>
