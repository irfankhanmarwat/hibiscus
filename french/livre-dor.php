...
<title>Hibiscus Beach Resort and Spa à l’île Maurice, Océan Indien, Pereybère - LIVRE D'OR</title>
...
#submit-form{width:70px; height:25px; margin-left:0px; text-align:center;}
.inputa{ width:180px;}
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../images/guestbook_ttl-fr.png) bottom left no-repeat;">LIVRE D'OR</h1>
            
            <div class="text">
                                                        <div id="buttonFormAdd">
    
                                            <img src="../images/expand.gif" border="0"  style="margin-right:5px; display:inline; cursor:pointer; padding-bottom: 2px; vertical-align: middle;" /><u>Donnez votre avis</u>
    
                                            </div>
    
                                            <div id="buttonFormRem">
    
                                            <img src="../images/collapse.gif" border="0"  style="margin-right:5px; display:inline; cursor:pointer; padding-bottom: 2px; vertical-align: middle;" /><u>Forme fermer</u>
            	...
            	<div class="ncontainr" style="height:156px;"> 
                    ...
                    <div style="margin-left:10px;" class="button2">
                                        ...
                                        <div id="addForm">
                                            ...
                                            <td><strong>Titre du message: </strong></td>
											...
											<td align="left">
                                              	<input name="submit" type="submit" id="submit-form" value="Envoyer" >
                                            	<input type="reset" name="Reset" id="reset-form" value="Remettre">
                                            </td>
                                            </tr>
                                            </table>
