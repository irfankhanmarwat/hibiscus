...
if ( isset($out['TotalRooms']) && $out['TotalRooms']>0 )
{
	...
	if ($show_terms!="") 
	{
		...
		<br>
		<br>
		<strong><u>Termes et Conditions:</u></strong><br>
		'.$show_terms;
	}
	$priceList1 .= '</p>';
} 
...
if ( isset($out['TotalRooms']) && $out['TotalRooms']>0 )
{
	...
	if ($show_terms!="") 
	{
		$priceList2 .= '
		<br>
		<strong style="font-size:13px; padding-bottom:5px;">Termes et Conditions:</strong><br />
		'.$show_terms;
	}
	$priceList2 .= '</p>';
} 
...
<title>Hibiscus Beach Resort and Spa à l’île Maurice, Océan Indien, Pereybère - TARIFS</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../images/rates_ttl-fr.png) bottom left no-repeat;">TARIFS</h1>
