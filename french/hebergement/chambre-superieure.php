...
<title>Hibiscus Beach Resort and Spa à l’île Maurice, Océan Indien, Pereybère - Chambre Supérieure</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/superiorroom_ttl-fr.png) bottom left no-repeat;">Chambre Supérieure</h1>
            
            <div class="text">
            
            	<div class="scroll-pane">
								
                                <h2 style="display:none;">Hébergement - Chambre Supérieure</h2>
