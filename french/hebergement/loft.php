...
<title>Hibiscus Beach Resort and Spa à l’île Maurice, Océan Indien, Pereybère - Loft</title>
<meta name="description" content="Bienvenue à l’Hibiscus Beach Resort and Spa sur l’île Maurice. Cet hébergement offre tous les services d’une Suite Senior avec balcon privé.">
<meta name="keywords" content="Loft, Hibiscus Beach Resort and Spa, hôtel maurice, chambres maurice, chambres supérieures maurice, suites juniors maurice, suites seniors maurice, Suites royales maurice, hôtels pereybère, chambres pereybère, chambres supérieures pereybère, suites juniors pereybère, suites seniors pereybère, Suites royales pereybère, chambres océan indien, chambres supérieures océan indien, suites juniors océan indien, suites seniors océan indien, Suites royales océan indien, vacances, pereybère, maurice, océan indien, îles, îles océan indien"><meta name="robots" content="all">
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/loft_ttl-fr.png) bottom left no-repeat;">Loft Suite</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Hébergement - Loft</h2>
                                
                                <p>Cet hébergement offre tous les services d’une Suite Senior avec balcon privé.</p>

<div class="listing" style="margin-bottom:0px;">
    <ul>
        <li>Surface - 52 m² donnant sur le lagon, pour le plus grand plaisir des yeux.</li>
...
<li>Spécificité: espace thé et café équipé de canapés canapés  artisanaux  pour vous détendre.</li>
    </ul>
</div>
