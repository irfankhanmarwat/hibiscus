...
<title>Hibiscus Beach Resort and Spa à l’île Maurice, Océan Indien, Pereybère - Superior Vue Mer</title>
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/superiorvermer_ttl-fr.png) bottom left no-repeat;">Superior Vue Mer</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Hébergement - Superior Vue Mer</h2>
