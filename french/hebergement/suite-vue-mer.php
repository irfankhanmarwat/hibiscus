...
<title>Hibiscus Beach Resort and Spa à l’île Maurice, Océan Indien, Pereybère – Suite Vue Mer</title>
<meta name="description" content="Bienvenue à l’Hibiscus Beach Resort and Spa sur l’île Maurice. Avec une vue spectaculaire sur le lagon et un balcon spacieux, la Suite Senior vous fait passer du rêve à la réalité">
<meta name="keywords" content="Suite Vue Mer, Hibiscus Beach Resort and Spa, hôtel maurice, chambres maurice, chambres supérieures maurice, suites juniors maurice, suites seniors maurice, Suites royales maurice, hôtels pereybère, chambres pereybère, chambres supérieures pereybère, suites juniors pereybère, suites seniors pereybère, Suites royales pereybère, chambres océan indien, chambres supérieures océan indien, suites juniors océan indien, suites seniors océan indien, Suites royales océan indien, vacances, pereybère, maurice, océan indien, îles, îles océan indien">
...
<body>
	...
	<div id="wrapper">
        ...
        <div id="content">
        	...
        	<h1 class="home_title" style="background:url(../../images/suite_ttl-fr.png) bottom left no-repeat;">Suite Vue Mer</h1>
            
            <div class="text">
            
            	<div class="ncontainr">
								
                                <h2 style="display:none;">Hébergement - Suite Vue Mer</h2>
                                
                                <p>Avec une vue spectaculaire sur le lagon et un balcon spacieux, la Suite Senior vous fait passer du rêve à la réalité.</p>

<div class="listing" style="margin-bottom:0px;">
    <ul>
        <li>Surface – 60 m² donnant sur le lagon, pour le plus grand plaisir des yeux.</li>
        <li>Spécificité: les suites sont équipées d’un jacuzzi et d'une grande salle de bains.</li>
        <li>Spécificité: balcon privé avec espace salon et bains de soleil.</li>
        <li>Spécificité: espace thé et café équipé de canapés faits main pour vous détendre.</li>
    </ul>
</div>
